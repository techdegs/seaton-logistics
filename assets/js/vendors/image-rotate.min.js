    ...
    return (
      (n.initTreeSixty = function () {
        n.css({
          ...
          i.spinner && n.spinner("start"),
          this.loadImages(),
          i.navigation && n.createNavigation();
        let e,
          t,
          a = !1,
          s = !1,
          ...
          .on("mousemove touchmove", function (o) {
            a &&
              ((t =
                "mousemove" === o.type
                  ? o.pageX
                  : o.originalEvent.touches[0].pageX) >
              e + i.dragSpeed
                ? ((s = !0), (e = t), n.previous())
                : t < e - i.dragSpeed && ((l = !0), (e = t), n.next()));
          })
      ...
      (n.loadImages = function () {
        let t, a, s, l;
        (t = e("<div/>").attr({ class: "images-display" })),
          (a = e("<ul/>").attr({ class: "images-list" }));
      ...
      (n.createNavigation = function () {
        ...
        o.on("mousedown touchstart", function (e) {
          e.preventDefault(),
            m
              ? (n
                  .find(".navigation-bar-play")
                  .removeClass("navigation-bar-stop"),
                (m = !1),
                clearInterval(d))
      ...
      (n.spinner = function (t) {
        let a;
        if (
          ((a = e("<div/>").attr({ class: "loading-spinner" })),
          n.append(a),
          "start" === t)
        ) {
          ...
          t > 991
            ? n
                ...
                .css({ height: i.smallHeight, width: i.smallWidth })
            : n
                .find(".loading-spinner")
                .css({
          ...
          "stop" === t
            ? n.find(".loading-spinner").css({ display: "none" })
      ...
      (n.togleFullScreen = function () {
        e(document)[0].fullscreenElement ||
        e(document)[0].mozFullScreenElement ||
        e(document)[0].webkitFullscreenElement ||
        e(document)[0].msFullscreenElement
          ? e(document)[0].exitFullscreen
            ...
            ? e(document)[0].mozCancelFullScreen()
            : e(document)[0].webkitExitFullscreen &&
              e(document)[0].webkitExitFullscreen()
          ...
          : e(this)[0].webkitRequestFullscreen &&
            e(this)[0].webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT);
      }),
      (n.resize = function () {
        n
          .find(".navigation-bar-resize")
          .toggleClass("navigation-bar-resize-small-icon"),
          e(document)[0].fullscreenElement ||
          e(document)[0].mozFullScreenElement ||
          e(document)[0].webkitFullscreenElement ||
          e(document)[0].msFullscreenElement
            ...
            : n
                .find(".images-display")
                .css({ height: "100%", width: "100%", margin: "auto" });
      }),
      n.on(
      ...
      e(window).resize(function (t) {
        ...
        a > 991
          ? n.css({ height: i.smallHeight, width: i.smallWidth })
          : n.css({
              "max-height": i.largeHeight,
              "max-width": i.largeWidth,
              height: a,
